...
!(function (t, e) {
	...
	function Ba(t, e) {
		...
		if (
			((e._time || (e._initted && !e._dur)) &&
				((r = ya(t.rawTime(), e)), (!e._dur || Tt(0, e.totalDuration(), r) - e._tTime > X) && e.render(r, !0)),
	...
	function $a(u, t) {
		...
		return (
			!e &&
				s(u) &&
				((h = e = u.radius || j), u.values ? ((u = xt(u.values)), (l = !q(u[0])) && (h *= h)) : (u = Za(u.increment))),
			Oa(
				t,
				e
					? p(u)
						...
						: function (t) {
								for (
									var e, r, i = parseFloat(l ? t.x : t), n = parseFloat(l ? t.y : 0), a = j, s = 0, o = u.length;
									o--;
	...
	function wb(t) {
		...
		if (((Pt.lastIndex = 0), Pt.test(r)))
			return (e = Ct.test(r)), (t[1] = tb(t[1], e)), (t[0] = tb(t[0], e, sb(t[1]))), !0;
	}
	function Fb(t) {
		var e = (t + '').split('('),
			r = zt[e[0]];
		...
		for (var r, i = t._first; i; )
			i instanceof Nt
				...
				: !i.vars.yoyoEase ||
				  (i._yoyo && i._repeat) ||
				  i._yoyo === e ||
				  (i.timeline ? Hb(i.timeline, e) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = e))),
				(i = i._next);
	}
	function Jb(t, e, r, i) {
		void 0 === r &&
	...
	function Mk(t) {
		...
		if (
			(k < a && (C += a - A),
			(0 < (e = (i = (S += a) - C) - z) || s) &&
				((n = ++b.frame), (T = i - 1e3 * b.time), (b.time = i /= 1e3), (z += e + (D <= e ? 4 : D - e)), (r = 1)),
			s || (m = g(Mk)),
			r)
		)
	...
	var It,
		...
		qt =
			...
			(It.totalDuration = function totalDuration(t) {
				return arguments.length
					? ((this._dirty = 0), Ja(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
					: this._tDur;
			}),
			...
			(It.time = function time(t, e) {
				return arguments.length
					? this.totalTime(
							Math.min(this.totalDuration(), t + wa(this)) % (this._dur + this._rDelay) || (t ? this._dur : 0),
							e
					  )
					: this._time;
			}),
			...
			(It.progress = function progress(t, e) {
				return arguments.length
					? this.totalTime(this.duration() * (!this._yoyo || 1 & this.iteration() ? t : 1 - t) + wa(this), e)
					: this.duration()
	...
	var Nt = (function (n) {
		...
		return (
			...
			(e.staggerFrom = function staggerFrom(e, r, i, n, a, s, o) {
				return (
					(i.runBackwards = 1), (oa(i).immediateRender = t(i.immediateRender)), this.staggerTo(e, r, i, n, a, s, o)
				);
			}),
			...
			(e.render = function render(t, e, r) {
				...
				if ((this !== I && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
					if (
						...
						if (((p = this._yoyo), (o = g + this._rDelay), this._repeat < -1 && t < 0))
						...
						((v === m && m >= this.totalDuration()) || (!v && _)) &&
							((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
								...
								e ||
									(t < 0 && !_) ||
									(!v && !_ && m) ||
									(Mt(this, v === m && 0 <= t ? 'onComplete' : 'onReverseComplete', !0),
			...
			(e.getChildren = function getChildren(t, e, r, i) {
				...
				for (var n = [], a = this._first; a; )
					a._start >= i &&
						(a instanceof Vt ? e && n.push(a) : (r && n.push(a), t && n.push.apply(n, a.getChildren(!0, e, r)))),
						(a = a._next);
				return n;
			}),
			...
			(e.remove = function remove(t) {
				return o(t)
					...
					: p(t)
					? this.killTweensOf(t)
					: (ra(this, t), t === this._recent && (this._recent = this._last), ta(this));
			}),
			(e.totalTime = function totalTime(t, e) {
				return arguments.length
					? ((this._forcing = 1),
					  !this._dp &&
							this._ts &&
							(this._start = da(St.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))),
			...
			(e.getTweensOf = function getTweensOf(t, e) {
				for (var r, i = [], n = xt(t), a = this._first, s = q(e); a; )
					a instanceof Vt
						? ea(a._targets, n) &&
						  (s
								? (!Qt || (a._initted && a._ts)) && a.globalTime(0) <= e && a.globalTime(a.totalDuration()) > e
								: !e || a.isActive()) &&
						  i.push(a)
				...
				(u = new ft[t]()).init(
					...
					u.rawVars
						...
						: (function _processVars(t, e, r, i, n) {
								if ((p(t) && (t = Xt(t, n, e, r, i)), !s(t) || (t.style && t.nodeType) || Z(t) || K(t)))
	...
	var Qt,
		Yt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
			...
			if (
				(o(i) &&
					...
					'=' === i.charAt(1) &&
						((!(l = parseFloat(d) + parseFloat(i.substr(2)) * ('-' === i.charAt(0) ? -1 : 1) + (Qa(d) || 0)) &&
							0 !== l) ||
							(i = l))),
				d !== i)
			)
				return isNaN(d * i) || '' === i
					...
					: ((l = new ae(this._pt, t, e, +d || 0, i - (d || 0), 'boolean' == typeof f ? $t : Zt, 0, c)),
					  h && (l.fp = h),
					...
					if (
						...
						for (a in i)
							ft[a] && (f = Tb(a, i, e, p, o, E))
								? f.priority && (u = 1)
								: (d[a] = s = Yt.call(e, o, a, 'get', i[a], p, E, 0, g.stringFilter));
					e._op && e._op[n] && e.kill(o, e._op[n]),
						F && e._pt && ((Qt = e), I.killTweensOf(o, d, e.globalTime(r)), (m = !e.parent), (Qt = 0)),
						e._pt && T && (lt[h.id] = 1);
				}
		...
		Vt = (function (C) {
			function Tween(e, r, i, n) {
				...
				return (
					!0 !== T || B || ((Qt = _assertThisInitialized(a)), I.killTweensOf(P), (Qt = 0)),
					...
					if (c) {
						if (
							...
							(l && l.render(t < 0 ? t : !i && u ? -X : l._dur * h, e, r)) || (this._startAt && (this._zTime = t)),
								this._onUpdate &&
									!e &&
									(t < 0 && this._startAt && this._startAt.render(t, !0, r), Mt(this, 'onUpdate')),
						...
						!(function _renderZeroDurationTween(t, e, r, i) {
							...
							if (
								...
								t._startAt && e < 0 && t._startAt.render(e, !0, !0),
									...
									(e >= t._tDur || e < 0) &&
										t.ratio === u &&
										(u && sa(t, 1), r || (Mt(t, u ? 'onComplete' : 'onReverseComplete', !0), t._prom && t._prom()));
						...
						for (r in e)
							for (i = a.length; i--; )
								(n = (n = t._ptLookup[i][r]) && n.d) &&
									(n._pt && (n = oc(n, r)), n && n.modifier && n.modifier(e[r], t, a[i], r));
					})(t, i);
				};
			}
		};
	...
	function Bd(t, e, r, i) {
		...
		return (
			...
			Ee[e] && 'transform' !== e
				? ((n = He(t, i)),
				  (n = 'transformOrigin' !== e ? n[e] : n.svg ? n.origin : Ke(pd(t, Ye)) + ' ' + n.zOrigin + 'px'))
				: ((n = t.style[e]) && 'auto' !== n && !i && !~(n + '').indexOf('calc(')) ||
				  (n = (Ve[e] && Ve[e](t, e, r)) || pd(t, e) || aa(t, e) || ('opacity' === e ? 1 : 0)),
	...
	function Md(t, e, r, i, n, a) {
		...
		r
			...
			i || (!1 !== i && h.smooth)
				? ((y = w - f), (b = x - d), (h.xOffset = p + (y * _ + b * g) - y), (h.yOffset = c + (y * m + b * v) - b))
	...
	function Yd(t, e, r) {
		...
		for (n in (l.svg
			...
			: ((a = getComputedStyle(r)[Qe]), (f[Qe] = e), (i = He(r, 1)), (f[Qe] = a)),
		Ee))
			(a = l[n]) !== (s = i[n]) &&
	...
	var ue,
		...
		rr = function _renderCSSTransforms(t, e) {
			...
			_ !== tr && (y += 'perspective(' + _ + er),
				(i || n) && (y += 'translate(' + i + '%, ' + n + '%) '),
				(!b && a === tr && s === tr && o === tr) ||
					(y += o !== tr || b ? 'translate3d(' + a + ', ' + s + ', ' + o + ') ' : 'translate(' + a + ', ' + s + er),
				u !== $e && (y += 'rotate(' + u + er),
				h !== $e && (y += 'rotateY(' + h + er),
				l !== $e && (y += 'rotateX(' + l + er),
				...
				d || p
					? ((d *= Re),
					  ...
					  p &&
							...
							(n *= s = Math.sqrt(1 + s * s)),
							(a *= s),
							c && ((s = Math.tan(c)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))),
					  (r = ca(r)),
					  (i = ca(i)),
					  (n = ca(n)),
					  (a = ca(a)))
					...
					if ('autoRound' !== d && ((s = e[d]), !ft[d] || !Tb(d, e, r, i, t, n)))
						if (
							...
							if (
								...
								d in Ne &&
									('autoAlpha' === d &&
										(1 === h && 'hidden' === Bd(t, 'visibility') && u && (h = 0),
								...
								if (
									...
									if ('transformOrigin' === d) {
										(s = Ed(s)),
											v.svg
												? Md(t, s, 0, y, 0, this)
												: ((c = parseFloat(s.split(' ')[2]) || 0) !== v.zOrigin && yd(this, v, 'zOrigin', v.zOrigin, c),
							...
							if (m || ((u || 0 === u) && (h || 0 === h) && !qe.test(s) && d in w))
								(u = u || 0),
									(p = (a + '').substr((h + '').length)) !== (c = Qa(s) || (d in Y.units ? Y.units[d] : p)) &&
										(h = Ad(t, d, a, c)),
									(this._pt = new ae(
										this._pt,
										m ? v : w,
										...
										h,
										_ ? _ * u : u - h,
										m || ('px' !== c && 'zIndex' !== d) || !1 === e.autoRound ? _c : cd
									)),
									(this._pt.u = c || 0),
